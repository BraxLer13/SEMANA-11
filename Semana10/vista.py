...
# ===================== VISTA DE MENÚ =====================
class VistaMenu:
    COLOR_LABEL = "#FFD166"  # Color uniforme amarillo para labels
...
class VistaFormulario:
    COLOR_LABEL = "#FFD166"  # Color uniforme amarillo para todos los labels
    ...
    def __init__(self, master, tipo):
        ...
        # Título según tipo de formulario
        if tipo == "invernadero":
